<?php
	...
	class mycart{
		...
		public function addItem($restaurant_id,$customer_id,$food_id,$quantity,$price){
			$query="INSERT INTO mycart(restaurant_id,customer_id,food_id,quantity,price,status) VALUES('$restaurant_id','$customer_id','$food_id','$quantity','$price','Added to Cart')";
